...
namespace SROCSVTOXLS
{
    class Program
    {
                    ...
                    try
                    {
                        ...
                        using (ExcelPackage package = new ExcelPackage(new FileInfo(excelResult), new FileInfo(templatePath)))
                        {
                            ...
                            foreach (CSVDefinition csvItem in query)
                            {
                                ...
                                WriteXLS(csvItem.CSVName, csvItem.Datatypes.ToArray(), package, startPositionExcel, format, csvFileName);
        ...
        static void WriteXLS(string sheetName, eDataTypes[] eType, ExcelPackage package, string startPositionExcel, ExcelTextFormat format, string csvFileName)
        {
