					        ...
					        <div class="carousel-inner" role="listbox">
					            <div class="item active">
					                ...
					                <div class="carousel-caption">
				               			...
				               			<p>Confira toda nossa linha de produtos com descontos especiais durante o mês</p>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-about-detail clearfix">
								...
								<div class="about-details">
									...
									<h3>Telefone</h3>
									<p>Façã seu pedido com toda a comodidade ligando para o nosso telefone. Atendemos de segunda a sábado das 09 as 18hrs. 
										<br /><br />
										<A HREF="tel:+551939095645">LIGUE AGORA: (19) 3909.5645</A></p>
								</div> 
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-about-detail">
								...
								<div class="about-details">
									...
									<h3>Whatsapp</h3>
									<p>Prefere um meio mais rápido? Pode fazer o seu contato pelo whatsapp nossos atendentes estarão disponiveis para pegar o seu pedido.
										<br /><br /><a href="https://api.whatsapp.com/send?phone=11946339200">CLIQUE AQUI PARA WHATSAPP</a>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-about-detail">
								...
								<div class="about-details">
									...
									<h3>Loja Fisica</h3>
									<p>Contamos com uma loja física onde você pode nos visitar na região de Hortolândia, assim você pode comprar e já sair com seu produto. <BR />
										<br /> <a href="https://maps.app.goo.gl/5yFLU8oaR9rp2vobA"> Antonio Francisco Lisboa 1660, Hortolândia - SP</a>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-2 single-member col-sm-4">
							...
							<div class="person-detail">
								<h3>Fitness</h3>
								<p>Oferecemos alimentos funcionais, Linhaça, Chia, Quinua, Amaranto, Psilium, Aveia, Uva passa, Ameixas e Castanhas, tudo para uma alimentação saudável.</p>
							</div>
						</div>
					...
					<div class="row">
							<div class="contact-caption clearfix">
								...
								<div class="col-md-5 contact-info text-left">
									<h3>Utilize o formulário ao lado para entrar em contato conosco e em breve retornaremos</h3>
									<!--<h3>Em breve responderemos</h3>-->
