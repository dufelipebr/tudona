...
namespace TudoNaStoreDAO
{
    public static class OurProductDAO
    {
        ...
        public static void InsertOurProduct(OurProductEntity obj, int clientID)
        {
            ...
            sql.Parameters.Add(new SqlParameter("@orderedBy", "1"));
        ...
        public static void UpdateOurProductSort(int OurProductID, int sortOrder)
        {
            SqlCommand sql = new SqlCommand(@"Update [dbo].[OurProducts]  set  where OurProductID = @OurProductID ");

            sql.Parameters.Add(new SqlParameter("@OurProductID", OurProductID));
            sql.Parameters.Add(new SqlParameter("@orderedBy", sortOrder));
